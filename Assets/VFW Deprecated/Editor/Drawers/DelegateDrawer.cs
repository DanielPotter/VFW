        ...
        public override void OnGUI()
        {
                ...
                // header
                {
                    ...
                    using (gui.Horizontal())
                    {
                        ...
                        using (gui.State(foldout))
                            prefs[kAdvanced] = gui.CheckButton(prefs[kAdvanced], "advanced mode", MiniButtonStyle.Right);
                    }
                }
            ...
            FOOTER:
                ...
                gui.Splitter();
                {
                    ...
                    using (gui.Horizontal())
                    {
                        using (gui.State(prefs[kAdd] && adding.source != null && adding.target != null && adding.method != null))
                        {
                        ...
                        if (adding.source != null)
                            prefs[kAdd] = gui.Foldout(prefs[kAdd]);
                        ...
                        using (gui.State(handlers.Count > 0 && (prefs[kInvoke] || paramless)))
                        {
                        ...
                        {
                            gui.Space(8f);
                            prefs[kInvoke] = gui.Foldout(prefs[kInvoke]);
                        }
                    }


                    // adding area: target -- method
                    if (prefs[kAdd] && adding.source != null)
                    {
                        gui.Space(5f);
                ...
                // body
                {
                    ...
                    for (int iLoop = 0; iLoop < handlers.Count; )
                    {
                        ...
                        using (gui.Horizontal())
                        {
                            ...
                            gui.Space(10f);
                            prefs[key] = gui.Foldout(prefs[key]);
                            gui.Space(-5f);
